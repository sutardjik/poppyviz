...
def set_favicon():
    ...
    st.set_page_config(page_title="PopPyViz", page_icon=favicon_path)
...
st.markdown(
    "<h1 style='text-align: center;'>PopPyViz</h1>",
